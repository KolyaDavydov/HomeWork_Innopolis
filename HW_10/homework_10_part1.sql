...
-- для проверки:
-- SELECT name, total_score, stipuxa
-- FROM students
-- JOIN stipendia ON students.id = stipendia.student_id;

--  UPDATE activity_scores SET score = 100 WHERE student_id = 3 AND activity_type = 'Exam';
